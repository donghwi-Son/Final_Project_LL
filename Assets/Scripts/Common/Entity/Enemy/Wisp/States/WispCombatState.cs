...
public class WispCombatState : State<Wisp>
{
    private Transform player;
    private int moveDir;

    public WispCombatState(Wisp owner, StateMachine<Wisp> stateMachine, string animBoolName) : base(owner, stateMachine, animBoolName)
    {
    }
